...
volcano_multi(
    input_data = q_data,
    filename = "../reports/figures/Regression Volcano/rma_regr_mcf7.png",
    title = "MCF-7 microarray probe expression",
...
for (GSE in dbs) {
    volcano_single(
        input_data = q_data,
        GSE = GSE,
        filename = paste0("../reports/figures/Regression Volcano/rma_regr_mcf7_", GSE, ".png"),
        title = GSE,
        xlab = "Linear regression slope",
        ylab = "-log10(q) (FDR adjusted)",
        xlim = xlims[GSE],
